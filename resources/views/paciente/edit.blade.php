...
@section('content')
  ...
  <div class="mb-3">
    ...
    <input id="cedula" name="cedula" type="number" class="form-control" value="{{$paciente->cedula}}">
  </div>
  <div class="mb-3">
    <label for="" class="form-label">Eps</label>
    <input id="id_eps" name="id_eps" type="number" class="form-control" value="{{$paciente->id_eps}}">
  </div>
